# Contributing to TenebrixCoin Core

TenebrixCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/tenebrixcoin/tenebrixcoin/labels/help%20wanted)
* [Projects](https://github.com/tenebrixcoin/tenebrixcoin/projects)
* [tenebrixcoindev on reddit](https://www.reddit.com/r/tenebrixcoindev/)

## Branch Strategy

TenebrixCoin Core's default branch is intentionally a stable release, so that anyone
...
TenebrixCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
