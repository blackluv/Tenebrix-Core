...
/*
 * tenebrixcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * tenebrixcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * TenebrixCoin: Get a fee targetting a specific transaction speed.
     */
