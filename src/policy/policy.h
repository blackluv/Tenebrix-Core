 ...
 *
 *  tenebrixcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * tenebrixcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * tenebrixcoin: Default hard dust limit that is evaluated when considering whether
