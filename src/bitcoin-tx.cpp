...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tenebrixcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tenebrixcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tenebrixcoin transaction") + "\n" +
              "  tenebrixcoin-tx [options] -create [commands]   " + _("Create hex-encoded tenebrixcoin transaction") + "\n" +
              "\n";
