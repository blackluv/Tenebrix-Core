...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the TenebrixCoin Core repository on GitHub"),
        tr("Services that claim to double your tenebrixcoin are always ponzi schemes")
    };
