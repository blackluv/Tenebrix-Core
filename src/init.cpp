...
void Shutdown()
{
    ...
    RenameThread("tenebrixcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tenebrixcoin-community/tenebrixcoin>";
    const std::string URL_WEBSITE = "<https://github.com/tenebrixcoin-community/tenebrixcoin>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("tenebrixcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("TenebrixCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // tenebrixcoin: Do we need to do any RPC mining init here?
