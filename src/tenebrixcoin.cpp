...
// TenebrixCoin: Normally minimum difficulty blocks can only occur in between
...
bool CheckAuxPowProofOfWork(const CBlockHeader& block, const Consensus::Params& params)
{
    ...
    if (!block.auxpow) {
        ...
        // We have to patch this because TenebrixCoin genesis block is invalid.
...
CAmount GetDogecoinBlockSubsidy(int nHeight, int nFees, const Consensus::Params& consensusParams, uint256 prevHash)
{
    ...
    /*if(nHeight < 50000)
    {
        ...
        nSubsidy >>= (nHeight / 100000); // Tenebrixcoin: 100K blocks in ~2 months
