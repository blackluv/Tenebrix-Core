...
example /usr/src/tenebrixcoin, AND not under, for example, /mnt/d/tenebrixcoin. 
...
way. This will install to `c:\workspace\tenebrixcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/tenebrixcoin
