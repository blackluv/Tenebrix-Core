...
* Discuss on [#tenebrixcoin-dev](http://webchat.freenode.net/?channels=tenebrixcoin-dev) on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=tenebrixcoin-dev).
