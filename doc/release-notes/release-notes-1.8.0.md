...
use "tenebrixcoind" you must run it the first time with the "-reindex" command line
option.
...
assigned numbers. DIP standards can be found at https://github.com/tenebrixcoin/dips/ .
...
A problem in parsing mangled tenebrixcoin: URIs under Windows has been resolved, and as
part of this work network detection for tenebrixcoin: URIs is now more robust.
