...
Where previously commands were sent to tenebrixcoind by running
"tenebrixcoind <command>", 1.7 adopts the model from Bitcoin Core 0.9 where there is
a separate "tenebrixcoin-cli" executable which is used instead. This avoids the risk
