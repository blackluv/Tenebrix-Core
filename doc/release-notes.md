TenebrixCoin Core version 1.14.6 is now available from:

  <https://github.com/tenebrixcoin/tenebrixcoin/releases/tag/v1.14.6/>
...
To receive notifications about updates, subscribe to the release mailing list:
  ...
  <https://sourceforge.net/projects/tenebrixcoin/lists/tenebrixcoin-releases>
...
```
tenebrixcoin-cli addnode <address> remove
```
...
```
tenebrixcoin-cli liststucktransactions
```
...
```
tenebrixcoin-cli setmaxconnections <desired_amount>
```
...
```
tenebrixcoin-cli rescan <start_block>
```
