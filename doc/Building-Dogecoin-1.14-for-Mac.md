### Building tenebrixcoin-qt 1.14 on modern macs. ###
...
### Clone tenebrixcoin locally, or check it out, etc. ###

For this purpose, just indicating the 1.14-branding branch in my repo.

	$git clone -b 1.14-branding --single-branch https://github.com/michilumin/tenebrixcoin.git
...
### Go back to your TenebrixCoin repo ###
